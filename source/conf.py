...
# The language for content autogenerated by Sphinx, and the default build
# language. The Korean build overrides this with `-D language=ko`
# (see the html-ko / livehtml-ko Makefile targets).
language = "en"

# -- Internationalization (gettext) -----------------------------------------

# Translation catalogs: source/locales/<lang>/LC_MESSAGES/**.po
locale_dirs = ["locales/"]

# One .po per source document (maps 1:1 to source files for doc-by-doc
# manual translation; the default True merges into huge per-directory files).
gettext_compact = False

# Skip per-message UUIDs: they bloat catalogs and churn in version control.
gettext_uuid = False
